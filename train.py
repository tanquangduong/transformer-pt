...
from transformer.utils import load_config, preprocessing_data, create_tranformer_model, get_checkpoint_path
...
def train(config):
    ...
    train_dataloader, val_dataloader, _, tokenizer_src, tokenizer_tgt = preprocessing_data(config)
